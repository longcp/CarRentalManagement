#include "clienteditwindow.h"
#include "ui_clienteditwindow.h"
#include <QToolBar>

ClientEditWindow::ClientEditWindow(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::ClientEditWindow)
{
    ui->setupUi(this);
...
ClientEditWindow::~ClientEditWindow()
{
    delete ui;
}

void
ClientEditWindow::openClientEditWindowSlot()
{
    this->show();
}
